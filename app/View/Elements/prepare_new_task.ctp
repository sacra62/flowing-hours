...
<div class="task" id="task_<?php echo $task['id']; ?>">
    ...
    <div><div class="task_inner">
            ...
            <hr/>
            <p><label>Start Date:</label> <span class="text_edit" rel="start_date" class="date"><?php echo $this->Time->format('j F, Y h:i', $task['start_date']); ?></span></p>
            <p><label>End Date:</label> <span class="text_edit" rel="end_date" class="date"><?php echo $this->Time->format('j F, Y h:i', $task['end_date']); ?></span></p>
